//
//  OnboardingFlow+PageInfoTests.swift
//  OnboardingKitTests
//
...
final class InfoTests: XCTestCase {
    ...
    func test_isFirstPage_returnsCorrectResult() {
        ...
        let obj2 = Info(pageIndex: 0, currentPageIndex: 0, totalPageCount: 10)
        let obj3 = Info(pageIndex: 1, currentPageIndex: 0, totalPageCount: 10)
    ...
    func test_isLastPage_returnsCorrectResult() {
        let obj1 = Info(pageIndex: 0, currentPageIndex: 0, totalPageCount: 10)
        let obj2 = Info(pageIndex: 10, currentPageIndex: 0, totalPageCount: 10)
        let obj3 = Info(pageIndex: 11, currentPageIndex: 0, totalPageCount: 10)
    ...
    func test_isCurrentPage_returnsCorrectResult() {
        let obj1 = Info(pageIndex: 0, currentPageIndex: 5, totalPageCount: 10)
        let obj2 = Info(pageIndex: 10, currentPageIndex: 10, totalPageCount: 10)
